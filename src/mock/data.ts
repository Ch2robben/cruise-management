...
const baseAttractions: Attraction[] = [
  { id: 'a01', name: '洪崖洞民俗风貌区', nameEn: 'Hongya Cave', portId: 'p10', portName: '重庆朝天门码头', city: '重庆', province: '重庆', address: '重庆市渝中区嘉陵江滨江路', longitude: 106.583, latitude: 29.563, category: '城市观光', visitDuration: '全年', portDistanceKm: 2.5, transferDurationMin: 20, openSeason: '全年', openHours: '11:00-23:00', suitableGroups: '普通游客、夜游团队、亲子客人', ticketPolicy: '开放街区免门票，团队餐和观景位需另行预约。', validationNotes: '夜景产品建议安排在晚间；若航次离港早于21:00，需提示游览体验不完整。', description: '重庆代表性吊脚楼建筑群，适合与朝天门登离船、山城夜景、两江游等产品组合。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-12 09:00:00',  createdAt: '2025-02-10 08:00:00' },
  { id: 'a02', name: '白鹤梁水下博物馆', nameEn: 'Baiheliang Underwater Museum', portId: 'p02', portName: '涪陵白鹤梁码头', city: '涪陵', province: '重庆', address: '重庆市涪陵区滨江大道二段', longitude: 107.391, latitude: 29.709, category: '历史人文', visitDuration: '全年', portDistanceKm: 3.2, transferDurationMin: 18, openSeason: '全年', openHours: '09:00-17:00', suitableGroups: '普通游客、研学团队、银发客人', ticketPolicy: '团队票需提前报备人数，讲解服务按批次预约。', validationNotes: '周一闭馆时不可排入行程；需校验靠泊窗口覆盖往返接驳和参观时间。', description: '以长江水文石刻为核心的水下博物馆，是三峡库区文化资源的重要节点。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-11 10:00:00',  createdAt: '2025-02-10 08:00:00' },
  { id: 'a03', name: '丰都名山景区', nameEn: 'Fengdu Mingshan Scenic Area', portId: 'p03', portName: '丰都名山码头', city: '丰都', province: '重庆', address: '重庆市丰都县名山街道', longitude: 107.727, latitude: 29.891, category: '历史人文', visitDuration: '3-11月', portDistanceKm: 4, transferDurationMin: 20, openSeason: '3-11月', openHours: '08:30-17:30', suitableGroups: '普通游客、文化主题团队', ticketPolicy: '门票按景区团队政策执行，索道费用可选。', validationNotes: '山地台阶较多，银发团队需预留更长游览时间。', description: '丰都经典岸上游览资源，适合与三峡文化、民俗传说主题产品组合。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-10 11:00:00',  createdAt: '2025-02-12 09:00:00' },
  { id: 'a04', name: '石宝寨', nameEn: 'Shibaozhai Pagoda', portId: 'p04', portName: '忠县石宝寨码头', city: '忠县', province: '重庆', address: '重庆市忠县石宝镇', longitude: 108.181, latitude: 30.328, category: '历史人文', visitDuration: '3-11月', portDistanceKm: 1.2, transferDurationMin: 10, openSeason: '3-11月', openHours: '08:30-17:30', suitableGroups: '普通游客、摄影团队', ticketPolicy: '团队票按景区政策结算。', validationNotes: '码头受水位影响明显，需与码头靠泊状态联动校验。', description: '长江岸边标志性木结构建筑，适合短停靠岸上游览。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-09 14:00:00',  createdAt: '2025-02-12 09:00:00' },
  { id: 'a05', name: '万州大瀑布', nameEn: 'Wanzhou Waterfall', portId: 'p05', portName: '万州港旅游码头', city: '万州', province: '重庆', address: '重庆市万州区甘宁镇', longitude: 108.321, latitude: 30.663, category: '自然景观', visitDuration: '4-10月', portDistanceKm: 31, transferDurationMin: 55, openSeason: '4-10月', openHours: '08:30-17:30', suitableGroups: '普通游客、亲子客人', ticketPolicy: '团队票需按人数提前确认。', validationNotes: '距离码头较远，停靠不足6小时不建议自动推荐。', description: '瀑布、峡谷和栈道结合的自然景观，适合万州长停靠航次。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-08 08:30:00',  createdAt: '2025-02-15 08:00:00' },
  { id: 'a06', name: '张飞庙', nameEn: 'Zhangfei Temple', portId: 'p06', portName: '云阳张飞庙码头', city: '云阳', province: '重庆', address: '重庆市云阳县盘石镇龙安社区', longitude: 108.713, latitude: 30.946, category: '历史人文', visitDuration: '全年', portDistanceKm: 5, transferDurationMin: 15, openSeason: '全年', openHours: '08:30-17:30', suitableGroups: '普通游客、三国文化主题团队', ticketPolicy: '团队票按景区结算。', validationNotes: '可作为云阳短停靠标准岸上项目。', description: '三国文化主题景点，适合与云阳停靠节点组合。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-07 15:00:00',  createdAt: '2025-02-15 08:00:00' },
  { id: 'a07', name: '白帝城·瞿塘峡', nameEn: 'White Emperor City', portId: 'p07', portName: '奉节宝塔坪码头', city: '奉节', province: '重庆', address: '重庆市奉节县白帝镇', longitude: 109.57, latitude: 31.045, category: '历史人文', visitDuration: '3-11月', portDistanceKm: 15, transferDurationMin: 35, openSeason: '3-11月', openHours: '08:00-17:30', suitableGroups: '普通游客、文化主题团队、摄影团队', ticketPolicy: '团队讲解和换乘车需提前预约。', validationNotes: '建议靠泊窗口不少于6小时；若叠加小三峡项目需拆分为整日行程。', description: '三峡文化核心景点，可远眺夔门，是三峡航线高频岸上项目。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-06 09:15:00',  createdAt: '2025-02-18 09:00:00' },
  { id: 'a08', name: '神女溪换乘游览', nameEn: 'Shennv Stream Excursion', portId: 'p08', portName: '巫山神女溪码头', city: '巫山', province: '重庆', address: '重庆市巫山县神女溪景区', longitude: 109.9, latitude: 31.082, category: '船岸联游', visitDuration: '4-10月', portDistanceKm: 0.8, transferDurationMin: 8, openSeason: '4-10月', openHours: '08:00-17:00', suitableGroups: '普通游客、摄影团队', ticketPolicy: '需按航次人数预留换乘船舶。', validationNotes: '必须校验换乘船运力和主船靠泊时间；恶劣天气需可替换方案。', description: '以换乘小船游览峡谷风光为主，是巫山段特色船岸联游项目。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-05 11:30:00',  createdAt: '2025-02-18 09:00:00' },
  { id: 'a09', name: '神农溪纤夫文化游', nameEn: 'Shennong Stream', portId: 'p09', portName: '巴东游客码头', city: '巴东', province: '湖北', address: '湖北省恩施州巴东县神农溪景区', longitude: 110.35, latitude: 31.04, category: '民俗体验', visitDuration: '4-10月', portDistanceKm: 3.5, transferDurationMin: 15, openSeason: '4-10月', openHours: '08:30-17:00', suitableGroups: '普通游客、民俗体验团队', ticketPolicy: '换乘船和表演批次需提前锁定。', validationNotes: '需校验换乘批次，停靠不足5小时不建议排入。', description: '峡谷风光与纤夫文化体验结合，适合三峡中段特色产品。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-04 14:45:00',  createdAt: '2025-02-20 08:00:00' },
  { id: 'a10', name: '三峡大坝旅游区', nameEn: 'Three Gorges Dam', portId: 'p15', portName: '宜昌三峡游客中心码头', city: '宜昌', province: '湖北', address: '湖北省宜昌市夷陵区三斗坪镇', longitude: 111.003, latitude: 30.823, category: '工程参观', visitDuration: '全年', portDistanceKm: 38, transferDurationMin: 60, openSeason: '全年', openHours: '08:00-17:30', suitableGroups: '普通游客、研学团队、银发客人', ticketPolicy: '实名预约，团队需提前提交名单。', validationNotes: '必须校验实名预约和交通时间；宜昌停靠不足6小时不推荐。', description: '世界级水利工程参观资源，是三峡航线宜昌段核心岸上项目。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-03 10:00:00',  createdAt: '2025-02-20 08:00:00' },
  { id: 'a11', name: '黄鹤楼', nameEn: 'Yellow Crane Tower', portId: 'p11', portName: '武汉港23号码头', city: '武汉', province: '湖北', address: '湖北省武汉市武昌区蛇山西山坡特1号', longitude: 114.302, latitude: 30.546, category: '城市观光', visitDuration: '3-11月', portDistanceKm: 7.5, transferDurationMin: 30, openSeason: '3-11月', openHours: '08:30-18:00', suitableGroups: '普通游客、文化主题团队', ticketPolicy: '团队票按景区政策执行。', validationNotes: '武汉城市交通拥堵时需增加接驳缓冲。', description: '中国四大名楼之一，适合武汉登离船或长停靠产品。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-02 08:30:00',  createdAt: '2025-02-22 09:00:00' },
  { id: 'a12', name: '南京夫子庙秦淮风光带', nameEn: 'Confucius Temple Qinhuai Area', portId: 'p12', portName: '南京五马渡码头', city: '南京', province: '江苏', address: '江苏省南京市秦淮区贡院街', longitude: 118.788, latitude: 32.021, category: '城市观光', visitDuration: '全年', portDistanceKm: 14, transferDurationMin: 40, openSeason: '全年', openHours: '09:00-22:00', suitableGroups: '普通游客、夜游团队、亲子客人', ticketPolicy: '开放街区免门票，游船和收费馆点另计。', validationNotes: '夜游产品需校验返船时间；大型节假日建议提示拥堵风险。', description: '南京代表性城市观光资源，适合与夜泊或长停靠组合。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-04-01 13:00:00',  createdAt: '2025-02-22 09:00:00' },
  { id: 'a13', name: '荆州古城', nameEn: 'Jingzhou Ancient City', portId: 'p13', portName: '荆州旅游码头', city: '荆州', province: '湖北', address: '湖北省荆州市荆州区张居正街', longitude: 112.19, latitude: 30.352, category: '历史人文', visitDuration: '3-11月', portDistanceKm: 8, transferDurationMin: 25, openSeason: '3-11月', openHours: '08:30-17:30', suitableGroups: '普通游客、三国文化主题团队', ticketPolicy: '城墙、博物馆等点位按实际组合结算。', validationNotes: '若组合多个馆点，需按开放时间拆分校验。', description: '三国文化和古城墙资源，可用于中游文化主题航线。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-03-31 09:00:00',  createdAt: '2025-02-25 08:00:00' },
  { id: 'a14', name: '岳阳楼景区', nameEn: 'Yueyang Tower', portId: 'p14', portName: '岳阳城陵矶码头', city: '岳阳', province: '湖南', address: '湖南省岳阳市岳阳楼区洞庭北路', longitude: 113.089, latitude: 29.378, category: '历史人文', visitDuration: '3-11月', portDistanceKm: 14, transferDurationMin: 35, openSeason: '3-11月', openHours: '07:30-18:00', suitableGroups: '普通游客、文化主题团队', ticketPolicy: '团队票按景区政策执行。', validationNotes: '需考虑城陵矶码头至市区接驳时间。', description: '洞庭湖畔名楼资源，适合岳阳停靠城市观光。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-03-30 15:30:00',  createdAt: '2025-02-25 08:00:00' },
  { id: 'a15', name: '庐山风景区', nameEn: 'Mount Lu', portId: 'p16', portName: '九江客运码头', city: '九江', province: '江西', address: '江西省九江市庐山市牯岭镇', longitude: 115.974, latitude: 29.556, category: '自然景观', visitDuration: '5-10月', portDistanceKm: 42, transferDurationMin: 75, openSeason: '5-10月', openHours: '07:30-18:00', suitableGroups: '体力较好客人、自然风光团队', ticketPolicy: '景区交通车和门票需提前确认。', validationNotes: '属于整日岸上游，停靠不足10小时不建议排入。', description: '世界文化景观遗产，适合长停靠或专线产品。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-03-29 10:45:00',  createdAt: '2025-02-28 09:00:00' },
  { id: 'a16', name: '上海外滩', nameEn: 'The Bund', portId: 'p20', portName: '上海十六铺码头', city: '上海', province: '上海', address: '上海市黄浦区中山东一路', longitude: 121.49, latitude: 31.24, category: '城市观光', visitDuration: '全年', portDistanceKm: 1, transferDurationMin: 10, openSeason: '全年', openHours: '全天', suitableGroups: '普通游客、夜游团队、摄影团队', ticketPolicy: '开放街区免门票，观光巴士和讲解服务另计。', validationNotes: '晚间观光体验最佳，需结合离船或夜泊时间安排。', description: '上海核心城市名片，可作为下水航线终点城市观光资源。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-03-28 08:00:00',  createdAt: '2025-02-28 09:00:00' },
  { id: 'a17', name: '葛洲坝船闸观光', nameEn: 'Gezhouba Dam View', portId: 'p24', portName: '葛洲坝码头', city: '宜昌', province: '湖北', address: '湖北省宜昌市西陵区葛洲坝', category: '工程参观', visitDuration: '全年', portDistanceKm: 0.5, transferDurationMin: 8, openSeason: '全年', openHours: '08:00-17:30', suitableGroups: '普通游客、研学团队', ticketPolicy: '观景平台按景区政策。', validationNotes: '可与三峡大坝行程拆分编排。', description: '葛洲坝水利枢纽观景，宜昌上游经典短停项目。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a18', name: '三峡大坝截流纪念园', nameEn: 'Dam Memorial Park', portId: 'p22', portName: '三峡大坝码头', city: '宜昌', province: '湖北', address: '湖北省宜昌市夷陵区三斗坪镇', category: '工程参观', visitDuration: '全年', portDistanceKm: 1, transferDurationMin: 10, openSeason: '全年', openHours: '08:00-17:30', suitableGroups: '普通游客', ticketPolicy: '与大坝参观联票或单售。', validationNotes: '停靠茅坪/大坝码头时可组合游览。', description: '三峡工程核心参观点，紧邻大坝码头。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a19', name: '巫山小三峡', nameEn: 'Wushan Little Three Gorges', portId: 'p31', portName: '巫山港码头', city: '巫山', province: '重庆', address: '重庆市巫山县龙门街道', category: '自然景观', visitDuration: '4-10月', portDistanceKm: 2, transferDurationMin: 15, openSeason: '4-10月', openHours: '08:00-17:00', suitableGroups: '普通游客、摄影团队', ticketPolicy: '换乘游船需提前预约。', validationNotes: '与神女溪项目二选一或分日安排。', description: '巫山港标准岸上游览项目。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a20', name: '沙市老街', nameEn: 'Shashi Old Street', portId: 'p25', portName: '沙市码头', city: '荆州', province: '湖北', address: '湖北省荆州市沙市区中山路', category: '城市观光', visitDuration: '全年', portDistanceKm: 3, transferDurationMin: 15, openSeason: '全年', openHours: '09:00-21:00', suitableGroups: '普通游客', ticketPolicy: '开放街区。', validationNotes: '中游宜昌-武汉段标准停靠点。', description: '沙市码头城市漫步资源。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a21', name: '瘦西湖风景区', nameEn: 'Slender West Lake', portId: 'p27', portName: '扬州旅游码头', city: '扬州', province: '江苏', address: '江苏省扬州市邗江区大虹桥路', category: '自然景观', visitDuration: '3-11月', portDistanceKm: 8, transferDurationMin: 25, openSeason: '3-11月', openHours: '06:00-18:30', suitableGroups: '普通游客、摄影团队', ticketPolicy: '团队票按景区政策。', validationNotes: '下游段长停靠推荐项目。', description: '扬州园林水系代表景区。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a22', name: '迎江寺', nameEn: 'Yingjiang Temple', portId: 'p19', portName: '安庆旅游码头', city: '安庆', province: '安徽', address: '安徽省安庆市迎江区沿江东路', category: '历史人文', visitDuration: '全年', portDistanceKm: 2, transferDurationMin: 12, openSeason: '全年', openHours: '08:00-17:00', suitableGroups: '普通游客', ticketPolicy: '门票按景区政策。', validationNotes: '安庆短停靠标准项目。', description: '安庆城区人文景点。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a23', name: '北外滩滨江步道', nameEn: 'North Bund Riverside', portId: 'p29', portName: '上海北外滩码头', city: '上海', province: '上海', address: '上海市虹口区东大名路', category: '城市观光', visitDuration: '全年', portDistanceKm: 0.3, transferDurationMin: 5, openSeason: '全年', openHours: '全天', suitableGroups: '普通游客', ticketPolicy: '免费开放。', validationNotes: '港区短停步行项目。', description: '北外滩码头步行观光。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
  { id: 'a24', name: '国客中心滨江观光', nameEn: 'Cruise Terminal Bund Tour', portId: 'p30', portName: '国客中心码头', city: '上海', province: '上海', address: '上海市虹口区东大名路500号', category: '城市观光', visitDuration: '全年', portDistanceKm: 0.2, transferDurationMin: 5, openSeason: '全年', openHours: '全天', suitableGroups: '普通游客', ticketPolicy: '免费开放。', validationNotes: '重庆-上海全程终点观光。', description: '国客中心码头滨江漫步。', status: 'enabled', updatedBy: '系统管理员', updatedAt: '2026-06-28 10:00:00', createdAt: '2026-06-28 10:00:00' },
]
...
export const hierarchicalDictItems: HierarchicalDictItem[] = [
  ...
  // 游轮设施
  { id: 'cf_l1_01', dictType: 'CRUISE_FACILITY', code: 'CRUISE_FACILITY', nameCn: '游轮设施', nameEn: 'Cruise Facilities', parentId: null, level: 1, sort: 1, remark: '游轮公共区域和配套设施', ...hierarchicalDictDefaults },
  { id: 'cf_l2_01', dictType: 'CRUISE_FACILITY', code: 'CRUISE_GYM', nameCn: '健身中心', nameEn: 'Fitness Center', parentId: 'cf_l1_01', level: 2, sort: 1, remark: '', ...hierarchicalDictDefaults },
  { id: 'cf_l2_02', dictType: 'CRUISE_FACILITY', code: 'CRUISE_POOL', nameCn: '恒温泳池', nameEn: 'Heated Pool', parentId: 'cf_l1_01', level: 2, sort: 2, remark: '', ...hierarchicalDictDefaults },
  { id: 'cf_l2_03', dictType: 'CRUISE_FACILITY', code: 'CRUISE_OBSERVATION', nameCn: '观景甲板', nameEn: 'Observation Deck', parentId: 'cf_l1_01', level: 2, sort: 3, remark: '', ...hierarchicalDictDefaults },
  { id: 'cf_l2_04', dictType: 'CRUISE_FACILITY', code: 'CRUISE_CHILDREN', nameCn: '儿童乐园', nameEn: "Children's Club", parentId: 'cf_l1_01', level: 2, sort: 4, remark: '', ...hierarchicalDictDefaults },
  { id: 'cf_l2_05', dictType: 'CRUISE_FACILITY', code: 'CRUISE_MULTI', nameCn: '多功能厅', nameEn: 'Multi-function Hall', parentId: 'cf_l1_01', level: 2, sort: 5, remark: '', ...hierarchicalDictDefaults },

  // 船舱设施
  { id: 'cbf_l1_01', dictType: 'CABIN_FACILITY', code: 'CABIN_FACILITY', nameCn: '船舱设施', nameEn: 'Cabin Facilities', parentId: null, level: 1, sort: 1, remark: '舱房内设施和基础配置', ...hierarchicalDictDefaults },
  { id: 'cbf_l2_01', dictType: 'CABIN_FACILITY', code: 'CABIN_BALCONY', nameCn: '独立阳台', nameEn: 'Private Balcony', parentId: 'cbf_l1_01', level: 2, sort: 1, remark: '', ...hierarchicalDictDefaults },
  { id: 'cbf_l2_02', dictType: 'CABIN_FACILITY', code: 'CABIN_BATH', nameCn: '独立卫浴', nameEn: 'Private Bathroom', parentId: 'cbf_l1_01', level: 2, sort: 2, remark: '', ...hierarchicalDictDefaults },
  { id: 'cbf_l2_03', dictType: 'CABIN_FACILITY', code: 'CABIN_MINIBAR', nameCn: '迷你吧', nameEn: 'Mini Bar', parentId: 'cbf_l1_01', level: 2, sort: 3, remark: '', ...hierarchicalDictDefaults },
  { id: 'cbf_l2_04', dictType: 'CABIN_FACILITY', code: 'CABIN_SMART', nameCn: '智能客控', nameEn: 'Smart Control', parentId: 'cbf_l1_01', level: 2, sort: 4, remark: '', ...hierarchicalDictDefaults },
  { id: 'cbf_l2_05', dictType: 'CABIN_FACILITY', code: 'CABIN_SAFETY', nameCn: '安全救生配置', nameEn: 'Safety & Lifesaving Kit', parentId: 'cbf_l1_01', level: 2, sort: 5, remark: '', ...hierarchicalDictDefaults },
...
/** 重庆→宜昌 航次可选航段（demo） */
export const bookingSegmentOptions = [
  { id: 'cq-yz', startPort: '重庆', endPort: '宜昌', days: 4, nights: 3, mileage: 310, isWhole: true },
  { id: 'cq-fd', startPort: '重庆', endPort: '丰都', days: 1, nights: 1, mileage: 120 },
  { id: 'cq-fj', startPort: '重庆', endPort: '奉节', days: 2, nights: 2, mileage: 205 },
  { id: 'fd-yz', startPort: '丰都', endPort: '宜昌', days: 3, nights: 2, mileage: 190 },
  { id: 'fd-fj', startPort: '丰都', endPort: '奉节', days: 1, nights: 1, mileage: 85 },
  { id: 'fj-yz', startPort: '奉节', endPort: '宜昌', days: 2, nights: 1, mileage: 105 },
]
...
export const voyageList = [
  ...
  { ship: '长江贰号', route: '重庆→宜昌', days: '下水4天3晚', date: '2026-06-22', deck: '8层甲板', price: '3680', stock: { std: 28, suite: 3 }, cabin: ['标准间','豪华套房','总统套房'], hot: true,
    cabins: [
