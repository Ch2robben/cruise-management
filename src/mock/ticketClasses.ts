...
export const ticketClassCatalog: TicketClassDef[] = [
  {
    ...
    name: '双成人',
    types: [
      { guestType: 'adult', occupancyType: '不拼房', label: '成人①' },
      { guestType: 'adult', occupancyType: '不拼房', label: '成人②' },
    ],
  },
  {
    id: 'tc-single',
    name: '单间',
    types: [{ guestType: 'adult', occupancyType: '不拼房', label: '成人' }],
  },
  {
    id: 'tc-1adult-1child',
    name: '一大一小（儿童占床）',
  ...
  },
  {
    ...
    types: [
      { guestType: 'adult', occupancyType: '不拼房', label: '成人①' },
      { guestType: 'adult', occupancyType: '不拼房', label: '成人②' },
      { guestType: 'baby', occupancyType: '不占座', label: '婴儿' },
    ],
  },
  {
    ...
    types: [
      { guestType: 'adult', occupancyType: '不拼房', label: '成人①' },
      { guestType: 'adult', occupancyType: '不拼房', label: '成人②' },
      { guestType: 'child', occupancyType: '不占座', label: '儿童' },
    ],
  },
  {
