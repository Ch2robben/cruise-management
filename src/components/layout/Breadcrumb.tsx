...
const routeLabels: Record<string, string> = {
  ...
  '/dealer/booking/task-claim': '任务认领',
  '/distribution/distribution-mgmt': '分销管理',
  '/distribution/discounts': '营销规则管理',
  '/orders': '订单管理',
  '/orders/list': '订单列表',
  ...
  '/rule/price-type': '政策列表',
  '/rule/policy-content': '规则/政策展示',
  '/rule/rebate': '返利政策管理',
  ...
  '/rule/close': '订单取消规则管理',
  '/basic': '基础设置',
  '/basic/holidays': '节假日设置',
  '/basic/id-types': '证件类型管理',
  '/basic/age-groups': '年龄段管理',
  '/basic/hierarchical-dictionaries': '分级字典',
  '/basic/activity-categories': '分级字典',
  '/basic/inventory-pools': '库存池管理',
  '/system': '系统设置',
  '/system/users': '用户管理',
  '/system/roles': '角色管理',
  '/system/menus': '菜单管理',
