    ...
    <RuleCrudPage
      config={{
        ...
        initialData: [
          ...
          createRuleRecord({ ...defaultForm, code: 'CAN-003', name: '包船临期取消', channel: '企业客户', amountType: 'percent', amountValue: 70, dueDays: 20, priority: 25, allowManualAdjust: false, remark: '包船订单临期取消按合同约定扣除70%。' }),
        ],
      }}
    />
  )
